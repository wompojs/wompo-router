(() => {
  ...
  var DEV_MODE, currentRenderingComponent, currentHookIndex, WC_MARKER, DYNAMIC_TAG_MARKER, isDynamicTagRegex, isAttrRegex, selfClosingRegex, isInsideTextTag, onlyTextChildrenElementsRegex, NODE, ATTR, TAG, IS_SERVER, doc, treeWalker, CachedTemplate, HtmlProcessedValue, DynamicNode, DynamicAttribute, DynamicTag, WompChildren, WompArrayDependency, __generateSpecifcStyles, __createHtml, __createDependencies, __createTemplate, __getRenderHtmlString, __shouldUpdate, __handleDynamicTag, __setValues, _$womp, useHook, useState, useEffect, useRef, useCallback, useIdMemo, useId, useMemo, useExposed, createContextMemo, createContext, useContext, wompDefaultOptions, registeredComponents, hasLoadingComponents;
  var init_womp = __esm({
    "../womp/dist/womp.js"() {
      DEV_MODE = false;
      ...
      currentHookIndex = 0;
      WC_MARKER = "$wc$";
      DYNAMIC_TAG_MARKER = "wc-wc";
      isDynamicTagRegex = /<\/?$/g;
      isAttrRegex = /\s+([^\s]*?)="?$/g;
      selfClosingRegex = /(<([a-z]*?-[a-z]*).*?)\/>/g;
      isInsideTextTag = /<(?<tag>script|style|textarea|title])(?!.*?<\/\k<tag>)/gi;
      onlyTextChildrenElementsRegex = /^(?:script|style|textarea|title)$/i;
      NODE = 0;
      ATTR = 1;
      TAG = 2;
      IS_SERVER = typeof global !== "undefined";
      doc = IS_SERVER ? { createTreeWalker() {
      } } : document;
      ...
      __generateSpecifcStyles = (component, options) => {
        const { css } = component;
...
This can lead to unexpected behaviors, because this component can alter other components' styles.`
      ...
      __createDependencies = (template, parts, attributes) => {
        const dependencies = [];
      ...
      __shouldUpdate = (currentValue, oldValue, dependency) => {
      ...
      __handleDynamicTag = (currentValue, currentDependency, valueIndex, dynamics, values) => {
      ...
      __setValues = (dynamics, values, oldValues) => {
      ...
      useEffect = (callback, dependencies = null) => {
        const [component, hookIndex] = useHook();
        if (!component._$hooks.hasOwnProperty(hookIndex)) {
          const effectHook = {
            dependencies,
      ...
      createContext = createContextMemo();
      useContext = (Context) => {
        const [component, hookIndex] = useHook();
      ...
      hasLoadingComponents = (node, notifyLoaded, loadingComponents = /* @__PURE__ */ new Set()) => {
  ...
  var buildTreeStructure, getRoutes, getWichParametricRouteisMoreSpecific, getMatch, getFullPath, RouterContext, SingleRouteContext, useParams, useNavigate;
  var init_Routes = __esm({
    "ts/Routes.tsx"() {
      init_womp();
      init_jsx_runtime();
      buildTreeStructure = (childNodes, structure = [], parent = null) => {
      ...
      getRoutes = (treeStructure, paths = [], parent = "") => {
      ...
      getWichParametricRouteisMoreSpecific = (routes) => {
      ...
      getFullPath = (prevRoute, newRoute) => {
      ...
      SingleRouteContext = createContext(null);
      defineWomp(Route, {
        name: "womp-route"
      });
  ...
  var Root = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsxs("p", { children: [
        ...
        /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Link, { to: "/", children: "Vai a Root" }) })
      ] }),
      /* @__PURE__ */ jsx(ChildRoute, {}),
      /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Link, { to: "teams", children: "Vai a Teams" }) })
    ] });
    ...
    return /* @__PURE__ */ jsxs(Routes, { children: [
      /* @__PURE__ */ jsxs(Route, { path: "/", element: /* @__PURE__ */ jsx(Root, {}), children: [
        ...
        /* @__PURE__ */ jsxs(Route, { path: "teams", element: /* @__PURE__ */ jsx(Teams, {}), children: [
          ...
          /* @__PURE__ */ jsx(Route, { path: ":teamId", lazy: () => Promise.resolve().then(() => (init_Team(), Team_exports)) }),
